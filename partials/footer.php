    ...
    <div class="py-12 px-8">
        <div class="flex items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="#" class="text-white hover:text-primary transition-colors" aria-label="TikTok">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.38a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.83a8.28 8.28 0 004.83 1.54V5.22a4.83 4.83 0 01-1.01-.53z"/>
                    </svg>
                </a>
            </div>
        </div>
        ...
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-white/60">
                    ...
                    <li><a href="#" class="hover:text-white transition-colors">Lista de deseos</a></li>
                </ul>
            </div>

            <div>
                <h3 class="text-sm font-bold uppercase tracking-wider mb-4 text-white">La marca</h3>
                <ul class="space-y-2 text-sm text-white/60">
                    <li><a href="#" class="hover:text-white transition-colors">Sobre Yofi</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Sustentabilidad</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Tiendas</a></li>
    ...
    <div class="border-t border-white/10">
        <div class="py-6 px-8">
            ...
            <p class="text-center text-xs text-white/40 mt-6">
                © 2025 <?php echo SITE_NAME; ?>. Todos los derechos reservados.
            </p>
        </div>
    </div>
</footer>
